...
<nav
	class="relative mx-auto flex w-full items-center justify-between border-zinc-200
	bg-opacity-60 py-8 pt-2 text-zinc-900
	dark:border-zinc-700 dark:text-zinc-100 sm:px-7 sm:pb-16"
>
	...
	<div class="flex items-center space-x-4">
		<!-- RSS -->
		<a
			class="rounded-lg border-sky-500 py-8 text-center"
			rel="external"
			href="/feed.xml"
			aria-label="RSS"
		>
		...
		<button
			...
			class="ml-1 flex aspect-square  h-9 items-center justify-center rounded-lg border-2  border-sky-500 text-center transition-all 
			hover:ring-2 dark:bg-sky-500 "
